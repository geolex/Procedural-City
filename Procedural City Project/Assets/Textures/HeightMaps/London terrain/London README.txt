...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=London&box=-0.020409,51.556243,-0.164891,51.466412
...
-----------
  ...
  * London Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * London Height Map (SRTM3 v4.1).png
  ...
  * London Height Map (SRTM30 Plus).png
